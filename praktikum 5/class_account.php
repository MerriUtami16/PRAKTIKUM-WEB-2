...
<h2 textalign='center'>Bank sejahtera</h2>
...
?>
<?php
$p1 = new accountBank("", "Angel", "");
$p1->daftar();
$p1->nabung(1000000);

$p2 = new accountBank("", "Gibran","" );
$p2->daftar();
$p2->tarik(2500000);
?>

<?php
    $p1 = ['id'=> 1, 'nomor' => 'C001', 'nama' => 'Angel', 'saldo' => 6000000];
    $p2 = ['id'=> 2, 'nomor' => 'C002', 'nama' => 'Gibran', 'saldo' => 5350000];
    $p3 = ['id'=> 3, 'nomor' => 'C003', 'nama' => 'Putra', 'saldo' => 2500000];
